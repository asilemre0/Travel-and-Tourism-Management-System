...
public class BookPackage extends JFrame implements ActionListener {
    ...
    BookPackage(String username) {
        ...
        text.setFont(new Font("Tahoms", Font.BOLD, 20));
        add(text);

        JLabel lblusername = new JLabel("Username");
        lblusername.setFont(new Font("Tahoms", Font.PLAIN, 16));
        lblusername.setBounds(40, 70, 100, 20);
        add(lblusername);

        labelusername = new JLabel();
        labelusername.setFont(new Font("Tahoms", Font.PLAIN, 16));
        ...
        image.setBounds(470, 40, 400, 420);
        add(image);
